...
echo "Or:"
echo "python3 -m pip install --user https://github.com/Hierosoft/nopackage/archive/refs/heads/main.zip"
echo "nopackage install /home/owner/git/b3view/build/b3view --version git --caption B3View"
